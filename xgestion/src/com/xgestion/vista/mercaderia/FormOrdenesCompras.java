...
import com.repository.transaccionales.CompraRepository;
 ...
 * @author dario
 */
public class FormOrdenesCompras extends javax.swing.JInternalFrame {

    private String titulo;
     
    public FormOrdenesCompras() {
        this.titulo = "O. Compras";
        initComponents();
        atajoTeclas();
        poblarTabla("");
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormOrdenCompra cm = new FormOrdenCompra(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormOrdenCompra cm = new FormOrdenCompra(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        CompraRepository a = new CompraRepository();
        List<Compra> x = a.getAllActivosFiltrado(texto, texto, titulo, texto, texto);
        //CABECERA TABLA
