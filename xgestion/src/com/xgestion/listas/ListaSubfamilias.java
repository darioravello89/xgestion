...
public class ListaSubfamilias extends JDialog {
	...
	private static List<Subfamilia> x;
    ...
    public ListaSubfamilias(Object object, List<Subfamilia > x) {
    ...
    public static void setSql(String sql) {
            ListaSubfamilias.sql = sql;
    }

    public void generarTabla(){	

        //TRAE LISTADO
        x = subfamiliaRepo.getAllActivos();
