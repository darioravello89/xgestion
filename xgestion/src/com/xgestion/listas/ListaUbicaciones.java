...
public class ListaUbicaciones extends JDialog {
	...
	private static List<Ubicacion> x;
    ...
    public ListaUbicaciones(Object object, List<Ubicacion > x) {
    ...
    public static void setSql(String sql) {
            ListaUbicaciones.sql = sql;
    }

    public void generarTabla(){	

        //TRAE LISTADO
        x = ubicacionRepo.getAllActivos();
