...
public class ListaProductos extends JDialog {
    ...
    public ListaProductos(Object object, List<Producto > x) {
    ...
    public static void setSql(String sql) {
            ListaProductos.sql = sql;
    }

    public void generarTabla(){	

        //TRAE LISTA DE CLIENTES
        x = productoRepo.getAllActivos();
        
        //CABECERA TABLA
        Object[] columnNames = {"CODIGO", "NOMBRE","PRECIO VENTA 1","PRECIO VENTA 2"};
        ...
        for (Producto  s : x) {
            ...
            o[0] = s.getCodigoBarras();
            o[1] = s.getNombre();
            o[2] = s.getPrecioVenta().toString();
            o[3] = s.getPrecioVenta2().toString();
            model.addRow(o);
        }
