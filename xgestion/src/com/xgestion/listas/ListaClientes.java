...
import com.xgestion2.repository.ClienteRepository;
...
public class ListaClientes extends JDialog {
    ...
    public ListaClientes(Object object, List<Cliente> x) {
    ...
    public static void setSql(String sql) {
            ListaClientes.sql = sql;
    }

    public void generarTabla(){	

        //TRAE LISTA DE CLIENTES
        x = clienteRepo.getAllActivos();
