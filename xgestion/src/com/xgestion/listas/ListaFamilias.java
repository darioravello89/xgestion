...
public class ListaFamilias extends JDialog {
    ...
    public ListaFamilias(Object object, List<Familia > x) {
    ...
    public static void setSql(String sql) {
            ListaFamilias.sql = sql;
    }

    public void generarTabla(){	

        //TRAE LISTADO
        x = familiaRepo.getAllActivos();
