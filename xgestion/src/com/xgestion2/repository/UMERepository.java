 ...
 * @author Marcelo
 */
public class UMERepository extends GenericRepository<UME, Long>{

    public List<UME> getAll(String buscar) {
        Session session = getSessionFactory().openSession();
        // Select * from autos  
        // from Auto
        List<UME> e= session.createQuery("from UME where nombre like :buscar and activo = true" )
