 ...
 * @author Marcelo
 */
public class MovimientoCodigoRepository extends GenericRepository<MovimientoCodigo, Long>{

    public List<MovimientoCodigo> getAll(String buscar) {
        Session session = getSessionFactory().openSession();
        // Select * from autos  
        // from Auto
        List<MovimientoCodigo> e= session.createQuery("from MovimientoCodigo where nombre like :buscar and activo = true" )
