 ...
 * @author Marcelo
 */
public class SucursalRepository extends GenericRepository<Sucursal, Long>{

    public List<Sucursal> getAll(String buscar) {
        Session session = getSessionFactory().openSession();
        // Select * from autos  
        // from Auto
        List<Sucursal> e= session.createQuery("from Sucursal where nombre like :buscar and activo = true" )
