 ...
 * @author Marcelo
 */
public class PagoRepository extends GenericRepository<Pago, Long>{

    public List<Pago> getAll(String buscar) {
        Session session = getSessionFactory().openSession();
        // Select * from autos  
        // from Auto
        List<Pago> e= session.createQuery("from Pago where nombre like :buscar and activo = true" )
