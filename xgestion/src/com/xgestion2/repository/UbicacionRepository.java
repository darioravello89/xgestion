 ...
 * @author Marcelo
 */
public class UbicacionRepository extends GenericRepository<Ubicacion, Long>{

    public List<Ubicacion> getAll(String buscar) {
        Session session = getSessionFactory().openSession();
        // Select * from autos  
        // from Auto
        List<Ubicacion> e= session.createQuery("from Ubicacion where nombre like :buscar and activo = true" )
