 ...
 * @author Marcelo
 */
public class ComputadoraRepository extends GenericRepository<Computadora, Long>{

    public List<Computadora> getAll(String buscar) {
        Session session = getSessionFactory().openSession();
        // Select * from autos  
        // from Auto
        List<Computadora> e= session.createQuery("from Computadora where nombre like :buscar and activo = true" )
