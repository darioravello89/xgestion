...
public class FormPagos extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormPago cm = new FormPago(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormPago cm = new FormPago(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        PagoRepository a = new PagoRepository();
        List<Pago> x = a.getAllActivos();
