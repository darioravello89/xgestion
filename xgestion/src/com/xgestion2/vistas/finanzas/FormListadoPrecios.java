 ...
 * @author dario
 */
public class FormListadoPrecios extends javax.swing.JInternalFrame {
    ...
    public FormListadoPrecios() {
        this.titulo = "Lista de Precios";
        initComponents();
        pueblaComboBoxes();
        atajoTeclas();
        poblarTabla("");
    ...
    private void poblarTabla(String texto){
        ...
        if(!familia[0].isEmpty() && Integer.valueOf(familia[0])!=0)
            fam = familiaRepo.get(Long.valueOf(subfamilia[0]));
        ...
        if(!ubicacion[0].isEmpty() && Integer.valueOf(ubicacion[0])!=0)
            ubi = ubicacionRepo.get(Long.valueOf(subfamilia[0]));
        if(!proveedor[0].isEmpty() && Integer.valueOf(proveedor[0])!=0)
            prov = proveedorRepo.get(Long.valueOf(subfamilia[0]));
        ...
        //CABECERA TABLA
        Object[] columnNames = {"Modificado", "Id", "Producto", "Precio Costo", "Ganancia", "Precio Venta", "Precio Costo 2", "Ganancia 2", "Precio Venta 2"};
