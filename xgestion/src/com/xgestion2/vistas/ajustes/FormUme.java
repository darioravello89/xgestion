 ...
 * @author dario
 */
public class FormUme extends javax.swing.JDialog {

    /**
     * Creates new form FormUME
     */
    private final Long id;
    private final UMERepository y = new UMERepository();
    private UME x = new UME();
    public FormUme(java.awt.Frame parent, boolean modal,Long id) {
        super(parent, modal);
        this.id = id;
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        if(id>0){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                y.update(x);
                dispose();
                FormUmes.jButtonBuscar.doClick();
            }
        }
