...
public class FormClientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabelEsquina, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormCliente cm = new FormCliente(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormCliente cm = new FormCliente(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        ClienteRepository a = new ClienteRepository();
        List<Cliente> x = a.getAllActivos();
        
        //CABECERA TABLA
        Object[] columnNames = {"ID", "NOMBRE","APELLIDO","TELEFONO"};
        ...
        //POBLAR REGISTROS
        for (Cliente s : x) {
            if(s.getNombre().toUpperCase().contains(texto.toUpperCase()) || s.getApellido().toUpperCase().contains(texto.toUpperCase()) 
                    || s.getTelefono().toUpperCase().contains(texto.toUpperCase())){
