...
public class FormProveedores extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormProveedor cm = new FormProveedor(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormProveedor cm = new FormProveedor(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        ProveedorRepository a = new ProveedorRepository();
        List<Proveedor> x = a.getAllActivos();
        
        //CABECERA TABLA
        Object[] columnNames = {"ID", "NOMBRE","CONTACTO","TELEFONO"};
        ...
        //POBLAR REGISTROS
        for (Proveedor s : x) {
            if(s.getNombre().toUpperCase().contains(texto.toUpperCase()) || s.getContacto().toUpperCase().contains(texto.toUpperCase()) 
