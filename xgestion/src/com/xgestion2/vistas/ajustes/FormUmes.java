 ...
 * @author dario
 */
public class FormUmes extends javax.swing.JInternalFrame {

    private String titulo = "U. Medidas";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormUme cm = new FormUme(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormUme cm = new FormUme(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        UMERepository a = new UMERepository();
        List<UME> x = a.getAllActivos();
