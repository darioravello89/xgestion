 ...
 * @author dario
 */
public class FormTurno extends javax.swing.JDialog {

    /**
     * Creates new form FormTurno
     */
    private final Long id;
    private final TurnoRepository y = new TurnoRepository();
    private Turno x = new Turno();
    public FormTurno(java.awt.Frame parent, boolean modal,Long id) {
        super(parent, modal);
        this.id = id;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 137, 37));
        ...
        getContentPane().add(jButtonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, 150, 50));
        ...
        getContentPane().add(jButtonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 150, 50));
        ...
        getContentPane().add(jButtonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 160, 50));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 137, 37));
        ...
        getContentPane().add(jFormattedTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 310, 40));
        ...
        getContentPane().add(jFormattedTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 310, 40));
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        if(id>0){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                y.update(x);
                dispose();
                FormTurnos.jButtonBuscar.doClick();
            }
        }
