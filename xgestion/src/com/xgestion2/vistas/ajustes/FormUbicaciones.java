 ...
 * @author dario
 */
public class FormUbicaciones extends javax.swing.JInternalFrame {
    
    private String titulo = "Ubicaciones";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormUbicacion cm = new FormUbicacion(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormUbicacion cm = new FormUbicacion(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        UbicacionRepository a = new UbicacionRepository();
        List<Ubicacion> x = a.getAllActivos();
