...
public class FormProductos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButtonNuevo1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButtonNuevo1.setMnemonic('M');
        jButtonNuevo1.setText("NUEVOS EN MASA");
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLayeredPane1Layout.createSequentialGroup()
                        .addComponent(jTextBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(13, 13, 13))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLayeredPane1Layout.createSequentialGroup()
                        .addComponent(jButtonNuevo1, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLayeredPane1Layout.createSequentialGroup()
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormProducto cm = new FormProducto(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormProducto cm = new FormProducto(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        ...
        List<Producto> x = a.getAllActivos();
        
        //CABECERA TABLA
        Object[] columnNames = {"ID", "NOMBRE","PRECIO VTA","PRECIO VTA 2"};
        ...
        //POBLAR REGISTROS
        for (Producto s : x) {
            if(s.getNombre().toUpperCase().contains(texto.toUpperCase()) || s.getPrecioVenta().toString().toUpperCase().contains(texto.toUpperCase()) 
                    || s.getPrecioVenta2().toString().toUpperCase().contains(texto.toUpperCase())){
                Object[] o = new Object[4];
                o[0] = s.getId();
                o[1] = s.getNombre();
                o[2] = s.getPrecioVenta();
                o[3] = s.getPrecioVenta2();
                model.addRow(o);
            }
        }
