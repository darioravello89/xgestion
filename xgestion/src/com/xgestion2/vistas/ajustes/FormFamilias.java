 ...
 * @author dario
 */
public class FormFamilias extends javax.swing.JInternalFrame {

    private String titulo;
     
    public FormFamilias() {
        this.titulo = "Familias";
        initComponents();
        atajoTeclas();
        poblarTabla("");
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormFamilia cm = new FormFamilia(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormFamilia cm = new FormFamilia(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        FamiliaRepository a = new FamiliaRepository();
        List<Familia> x = a.getAllActivos();
