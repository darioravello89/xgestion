...
public class FormUsuarios extends javax.swing.JInternalFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            FormUsuario cm = new FormUsuario(null,true,Long.valueOf(id));
            cm.setVisible(true);
    ...
    private void jButtonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNuevoActionPerformed
        // TODO add your handling code here:
        FormUsuario cm = new FormUsuario(null,true,Long.valueOf(0));
        cm.setVisible(true);
    ...
    private void poblarTabla(String texto){
        UsuarioRepository a = new UsuarioRepository();
        List<Usuario> x = a.getAllActivos();
        
        //CABECERA TABLA
        Object[] columnNames = {"ID", "NOMBRE","APELLIDO","USUARIO"};
        ...
        for (Usuario s : x) {
            if(s.getNombre().toUpperCase().contains(texto.toUpperCase()) || s.getApellido().toUpperCase().contains(texto.toUpperCase()) 
                    || s.getUsuario().toUpperCase().contains(texto.toUpperCase())){
